      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            ...
            <Text style={text}>
              Thank you for registering for an account on {APP_TITLE}. To complete your registration, please verify your
              your account by using the following code:
            </Text>
